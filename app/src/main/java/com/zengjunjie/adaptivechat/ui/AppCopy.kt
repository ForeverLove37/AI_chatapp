...
data class AppCopy(
    ...
    val cropAvatar: String,
    val cropAvatarDetail: String,
    val zoom: String,
    val resetCrop: String,
    val applyCrop: String,
    val processingCrop: String,
    val cropAvatarError: String,
    val language: String,
    val languageDetail: String,
    val appearance: String,
    val appearanceDetail: String,
    val expertMode: String,
    val expertModeDetail: String,
    val expertModeOn: String,
    val expertModeOff: String,
    val textSize: String,
...
private val EnglishCopy = AppCopy(
    ...
    cropAvatarDetail = "Drag to reposition the image, then adjust the scale.",
    zoom = "Zoom",
    resetCrop = "Reset",
    applyCrop = "Apply crop",
    processingCrop = "Processing",
    cropAvatarError = "The cropped avatar could not be created.",
    language = "Language",
    ...
    expertModeDetail = "Show the raw upstream model list assigned to your account.",
    expertModeOn = "Expert models enabled",
    expertModeOff = "Expert models hidden",
    textSize = "Text size",
...
private val ChineseCopy = AppCopy(
    ...
    cropAvatar = "裁剪头像",
    cropAvatarDetail = "拖动图片调整位置，然后设置缩放比例。",
    zoom = "缩放",
    resetCrop = "重置",
    applyCrop = "应用裁剪",
    processingCrop = "正在处理",
    cropAvatarError = "无法生成裁剪后的头像。",
    language = "语言",
    languageDetail = "选择应用显示语言。",
    appearance = "外观",
    appearanceDetail = "跟随系统，或选择浅色和深色界面。",
    expertMode = "专家模式",
    expertModeDetail = "显示管理员为你的账户分配的上游原始模型。",
    expertModeOn = "已启用专家模型",
    expertModeOff = "已隐藏专家模型",
    textSize = "文字大小",
